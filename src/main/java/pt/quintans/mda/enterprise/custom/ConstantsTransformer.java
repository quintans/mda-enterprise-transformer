...
import pt.quintans.mda.enterprise.model.constant.Item;
...
public class ConstantsTransformer extends AbstractTransformer {
	...
	public pt.quintans.mda.enterprise.model.constant.Constants instanciate() {
		return new pt.quintans.mda.enterprise.model.constant.Constants();
	}
	...
	public void create(Model model, String objectName) {
		...
		pt.quintans.mda.enterprise.model.constant.Constants constants = instanciate();
