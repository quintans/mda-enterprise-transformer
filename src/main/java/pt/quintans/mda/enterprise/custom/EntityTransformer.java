...
import pt.quintans.mda.enterprise.core.ElementType;
...
import pt.quintans.mda.enterprise.model.entity.Bool;
import pt.quintans.mda.enterprise.model.entity.Constraint;
import pt.quintans.mda.enterprise.model.entity.DateComposite;
import pt.quintans.mda.enterprise.model.entity.Element;
import pt.quintans.mda.enterprise.model.entity.FlagBool;
import pt.quintans.mda.enterprise.model.entity.FlagLov;
import pt.quintans.mda.enterprise.model.entity.Flags;
import pt.quintans.mda.enterprise.model.entity.Index;
import pt.quintans.mda.enterprise.model.entity.Operation;
import pt.quintans.mda.enterprise.model.entity.Relation;
import pt.quintans.mda.enterprise.model.entity.UniqueGroup;
...
public class EntityTransformer extends AbstractTransformer {
	...
	private void defineKey(pt.quintans.mda.enterprise.model.entity.Entity ent, Attribute at, BaseAttributeType attr) {
	...
	public pt.quintans.mda.enterprise.model.entity.Entity instanciate() {
		return new pt.quintans.mda.enterprise.model.entity.Entity();
	}
	...
	public void create(final Model model, String objectName) {
		...
		final pt.quintans.mda.enterprise.model.entity.Entity ent = instanciate();
	...
	public void relate(Model model, String objectName) {
		...
		Basic basic = me.getSource();
		Entity modelEntity = (Entity) basic;
		pt.quintans.mda.enterprise.model.entity.Entity ent = (pt.quintans.mda.enterprise.model.entity.Entity) me.getTransformed();
		...
		if (modelEntity.getAssociations() != null) {
			...
			for (SimpleAssociationType assoc : modelEntity.getAssociations().getAssociationsList()) {
				...
				pt.quintans.mda.enterprise.model.entity.Entity targetEntity = (pt.quintans.mda.enterprise.model.entity.Entity) model.getTransformedObject(assoc
						.getEntity());
				...
				if (assoc.getRelationAndConstraint().size() > 0) {
					...
					for (ElementType et : assoc.getRelationAndConstraint()) {
					    if(et instanceof RelationType){
                            ...
                            if(target != null){
                                pt.quintans.mda.enterprise.model.entity.Entity e = null;
        ...
        if (modelEntity.getAttributes() != null) {
            ...
            for (BaseAttributeType attr : modelEntity.getAttributes().getAttributesList()) {
                ...
                if ("nested".equals(attr.getElementType())) {
                    ...
                    pt.quintans.mda.enterprise.model.entity.Entity targetEntity = (pt.quintans.mda.enterprise.model.entity.Entity) model.getTransformedObject(nested.getKind());
