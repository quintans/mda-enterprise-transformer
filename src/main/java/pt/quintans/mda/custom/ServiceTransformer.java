...
import pt.quintans.mda.model.service.Operation;
...
public class ServiceTransformer extends AbstractTransformer {
	...
	public pt.quintans.mda.model.service.Service instanciate() {
		return new pt.quintans.mda.model.service.Service();
	}
	...
	public void create(Model model, String objectName) {
		...
		pt.quintans.mda.model.service.Service srv = instanciate();
	...
	public void relate(Model model, String objectName) {
		...
		pt.quintans.mda.model.service.Service srv = (pt.quintans.mda.model.service.Service) me.getTransformed();
