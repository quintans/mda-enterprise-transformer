...
public class LovTransformer extends AbstractTransformer {
	...
	public pt.quintans.mda.model.lov.ListOfValues instanciate() {
		return new pt.quintans.mda.model.lov.ListOfValues();
	}
	...
	public void create(Model model, String objectName) {
		...
		pt.quintans.mda.model.lov.ListOfValues lov = instanciate();
