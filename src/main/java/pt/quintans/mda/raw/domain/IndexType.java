 ...
 *       &lt;sequence>
 *         &lt;element name="member" type="{http://www.mda.quintans.pt}IndexMemberType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
    ...
    extends BaseType
{
    ...
    protected List<IndexMemberType> member;
     ...
     * {@link IndexMemberType }
     * 
     * 
     */
    public List<IndexMemberType> getMember() {
        if (member == null) {
            member = new ArrayList<IndexMemberType>();
        }
        return this.member;
    }
